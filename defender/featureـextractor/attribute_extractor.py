...
class JSONAttributeExtractor():
    ...
    def extract(self):
        ...
        # get general info
        self.attributes.update({
            "size": self.data["general"]["size"] or 0, 
            "virtual_size": self.data["general"]["vsize"] or 0,
            "has_debug": self.data["general"]["has_debug"] or 0, 
            "imports": self.data["general"]["imports"] or 0,
            "exports": self.data["general"]["exports"] or 0,
            "has_relocations": self.data["general"]["has_relocations"] or 0,
            "has_resources": self.data["general"]["has_resources"] or 0,
            "has_signature": self.data["general"]["has_signature"] or 0,
            "has_tls": self.data["general"]["has_tls"] or 0,
            "symbols": self.data["general"]["symbols"] or 0,
        })
        ...
        self.attributes.update({
            ...
            "machine": self.data["header"]["coff"]["machine"] or "",
            # TODO: NFS only
